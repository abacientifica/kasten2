<template>
    <div>
    <div class="modal fade" v-if="modalShow = opcionDialog.modalHomologarCotDet" :class="{ show: opcionDialog.modalHomologarCotDet }" :style=" opcionDialog.modalHomologarCotDet ? mostrarModal : ocultarModal" role="dialog" aria-labelledby="myModalLabel"  aria-hidden="true">
...
export default {
    props:['visible','datosItem','datosPl'],
    data() {
        return {
            tituloModal: '',
    ...
    computed:{
        ...mapGetters('OpcionesModalCot',['opcionDialog']),
    ...
    methods: {
        ...mapActions('OpcionesModalCot', ['cerrarModal']),
